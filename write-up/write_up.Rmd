...
**Trying to find love in the 21st century? The Bachelor franchise can help!** Twitter and television shows, The Bachelor and The Bachelorette, are key components of American culture today. This project seeks to better understand the relationship between these two media forms. Using text analysis, we explore the polarity of tweet content as well as associated words that people use to describe the show. These trends are visualized and vary by state, show season, and time.
